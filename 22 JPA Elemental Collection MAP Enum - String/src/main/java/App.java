...
public class App {
	...
	public static void main(String[] args) {
		...
		Map<EmailType, String> mail = new HashMap();

		mail.put(EmailType.Kişisel, "recep.baykan97@gmail.com");
		mail.put(EmailType.IS, "dmental123@gmail.com");
		...
		Map<EmailType, String> mail2 = new HashMap();

		mail2.put(EmailType.Kişisel, "super_asker@gmail.com");
		mail2.put(EmailType.IS, "koyu_salazar@gmail.com");
		...
		System.out.print(userRepositoryImpl.find(1).toString());
